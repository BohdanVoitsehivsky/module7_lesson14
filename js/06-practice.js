...
// **** користувач вводить
//  своє імя після втсрати фокусу
//  і отримує алерт з повідомленням_привітанням
...
// console.log(info);
// // event.target.reset();  очищає форму після введення 

// }

// **** типи подій : keypress, keydown, keyup
// обмеження keypress
// ** влвстивості key та code
...
// ***** події миші
// *** mouseenter  mouseleave (це ховер)
// **** mouseover    mouseout
// *** mousemove ( chatty event - балакуча подія можна відстежувати рух мишки)


// const box = document.querySelector(".sjs.box");
// // box.addEventListener("mouseover", onMouseEnter);
// // box.addEventListener("mouseout", onMouseLeave);
// box.addEventListener("mousemove", onMouseLeave)
...
<h3 class="car-price">${car.type}</h3>
